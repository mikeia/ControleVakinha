object frmLancamento: TfrmLancamento
  ...
  object pnPrincipal: TPanel
    ...
    object lblUsuarioLogado: TLabel
      ...
      Height = 13
      AutoSize = False
      Caption = 'Usu'#225'rio logado: Thais'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object rdTipoDeposito: TRadioGroup
      Left = 103
      Top = 47
      Width = 250
      Height = 49
      Caption = 'Tipo Dep'#243'sito'
      Columns = 2
      ItemIndex = 0
      Items.Strings = (
        'Novo Dep'#243'sito'
  ...
  object qryLancaMov: TFDQuery
    ...
    object qryLancaMovID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryLancaMovTP_MOVIMENT: TStringField
      FieldName = 'TP_MOVIMENT'
      Origin = 'TP_MOVIMENT'
      FixedChar = True
      Size = 1
    end
    object qryLancaMovID_USER: TIntegerField
      FieldName = 'ID_USER'
      Origin = 'ID_USER'
      Required = True
    end
    object qryLancaMovMOTIVE: TStringField
      FieldName = 'MOTIVE'
      Origin = 'MOTIVE'
      Size = 250
    end
    object qryLancaMovDATE_MOVIMENTS: TDateField
      FieldName = 'DATE_MOVIMENTS'
      Origin = 'DATE_MOVIMENTS'
    end
    object qryLancaMovVALUE_MOVIMENTS: TSingleField
      FieldName = 'VALUE_MOVIMENTS'
      Origin = 'VALUE_MOVIMENTS'
      currency = True
    end
  end
  object dsLancaMov: TDataSource
    DataSet = qryLancaMov
    OnStateChange = dsLancaMovStateChange
    Left = 400
    Top = 176
  end
  object qryUltimo: TFDQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT MAX(ID) AS ULTIMO FROM MOVIMENTS')
    Left = 400
    Top = 216
  ...
  object qryExec: TFDQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT VALUE_MOVIMENTS FROM MOVIMENTS WHERE ID = :ID')
    Left = 416
    Top = 64
    ParamData = <
      item
