...
begin
  if edtCod.Text <> '' then
  begin
    if MessageDlg('Deseja excluir esse lançamento?',mtConfirmation, [mbYes,mbNo],0) = mrYes then
    begin
      ...
      begin
        ...
        begin
          ShowMessage('Não é possivel exluir um Depósito maior que o Saldo Atual');
  ...
  begin
    ShowMessage('Nenhum lançamento informado para exclusão!');
    exit;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ShowMessage('Valor de retirada não pode ser maior que Saldo Atual!');
          dbValue.Clear;
          dbValue.SetFocus;
          exit;
        end;
    ...
    case vTpMoviment of
      1: ShowMessage('Depósito realizado com sucesso!');
  ...
  begin
    ShowMessage('Descrição e Valor são obrigatórios ');
    dbMotive.SetFocus;
    exit;
  end;
...
begin
 ...
 lblUsuarioLogado.Caption:= 'Usuário logado: ' + frmLogin.vUsuario;
end;
